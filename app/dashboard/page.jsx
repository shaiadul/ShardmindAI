...
const page = () => {
  return (
    <div>
      <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-[#0C051F] text-white">
        {/* Dashboard header section */}
        <div class=" w-full flex items-center justify-between h-14 ">
          <div class="flex items-center justify-start md:justify-center pl-3 w-28 md:w-64 h-14 border-none">
            <img
              class="object-contain h-10"
              src="https://i.ibb.co/ZY7Jvzk/logo2.png"
            />
          </div>
          <div class="flex justify-between items-center h-14 header-right mr-5">
            <ul class="flex items-center">
              ...
              <li>
                <div className="w-8 h-8 object-fit">
                  <img
        ...
        {/* Sidebar */}
        <div class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 h-full transition-all duration-300 border-none z-10 sidebar">
        ...
        <div class="h-full ml-14 mt-14 mb-10 md:ml-64"></div>
      </div>
    </div>
  );
};
